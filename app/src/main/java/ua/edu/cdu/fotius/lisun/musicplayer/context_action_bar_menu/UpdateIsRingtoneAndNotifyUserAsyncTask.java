...
public class UpdateIsRingtoneAndNotifyUserAsyncTask extends AsyncTaskWithProgressBar {
    ...
    public UpdateIsRingtoneAndNotifyUserAsyncTask(Fragment fragment, Uri uri, long tracksId) {
        super(fragment);
        mUri = uri;
        mTrackId = tracksId;
