...
public class ViewDragHelper {
     ...
     * The callback's {@link ua.edu.cdu.fotius.lisun.musicplayer.slidingup_panel.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link ua.edu.cdu.fotius.lisun.musicplayer.slidingup_panel.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link ua.edu.cdu.fotius.lisun.musicplayer.slidingup_panel.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link ua.edu.cdu.fotius.lisun.musicplayer.slidingup_panel.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
