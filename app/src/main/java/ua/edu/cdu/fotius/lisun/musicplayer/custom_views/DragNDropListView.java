...
public class DragNDropListView extends ListView {
    ...
    private int mNextDragPoisition;
    ...
    public void setDragHandlerResourceID(int resourceID) {
        mDragHandlerResourceID = resourceID;
    }
...
//        paint.setColor(Color.BLACK);
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        mAboveItemId = adapter.getIDForPosition(position - 1);
        mBelowItemId = adapter.getIDForPosition(position + 1);
    }
    ...
    public boolean isDrag(MotionEvent ev) {
        ...
        View handler = parent.findViewById(mDragHandlerResourceID);
    ...
    public boolean onTouchEvent (MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                mStartDragPosition = mNextDragPoisition = position;

                int itemNum = position - getFirstVisiblePosition();

                View selectedView = getChildAt(itemNum);
                mMobileItemId = ((QueueCursorAdapter)getAdapter()).getIDForPosition(position);
