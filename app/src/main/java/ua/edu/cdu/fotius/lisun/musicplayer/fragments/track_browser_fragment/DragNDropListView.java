...
public class DragNDropListView extends ListView {
    ...
    public interface OnDragNDropEventListener {
        public void onDrop(int from, int to);
    }

    private OnDragNDropEventListener mDragNDropEventListener;
    ...
    public void setDragNDropEventListener(OnDragNDropEventListener listener) {
        mDragNDropEventListener = listener;
    }
    ...
    public boolean onTouchEvent (MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                int position = mDragPosition = pointToPosition(mDownX, mDownY);
    ...
    private void touchEventsEnded () {
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            //TODO:
            mDragNDropEventListener.onDrop(mDragPosition, mDropPosition);
            mDragPosition = -1;
            mDropPosition = -1;
